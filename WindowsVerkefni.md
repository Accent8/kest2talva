### Lab 10.3.1.1 - Windows Installation : Búið
...
#### 10) Open DirectX diagnostic tool, in the System tab what does this tool report? Upplýsingar um DirectX íhluti og drivera sem eru uppsettir á tölvunni
#### 11) What information is listed in the Display page? Upplýsingar um DirectX feature-a, Driver-a og Device-ið
...
#### 8) What option of xcopy allows you to copy all the files and directories, including the empty directories? xcopy /E og svo hvaða directory þú vilt copy-a
#### 9) use rd Folder1, were you able to delete the directory? Nei ég gat ekki deletað því þar sem directoryið var ekki tómt
#### 10) What are the advantages of using CLI vs GUI? CLI er hraðara en GUI og getur verið einfaldara að setja upp tölvu kerfi með CLI en fyrir flesta er öruglega þæginlegar að nota GUI þar sem þú sérð hvað þú ert að gera ef þú veist ekki hvað commandinn gera.
### Lab 11.4.3.2 - Disk CLI Commands
#### 1) what is the option to fix errors on the drive? chkdsk /F
#### 2) what is the option to force the volume to dismount first if necessary? chkdsk /X
...
#### 6) enter the list partition to list all th partitions on the disk, how many partitions are on the disk? ![image](https://user-images.githubusercontent.com/114400552/215101707-53994074-17b4-4a2a-afb1-fbbb06c6282a.png) 
####
####
####
####
